	            ...
	            <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_pegawai" class="form-control" placeholder="Masukan No Pegawai" required />
                        </div>
                        <div class="form-group">
                    ...
                    <?php
                        ...
                        $sql1 = mysqli_query($koneksi, "INSERT INTO user(id_user, nama, no_pegawai, username, email, password, alamat, no_hp, level, status) VALUES (null, '$nama', '$no_pegawai', '$username', '$email', '$password', '$alamat', '$no_hp', '$level', '$status')") or die ($koneksi->error);
