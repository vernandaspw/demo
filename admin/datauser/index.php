...
<div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <?php
                            $no = 1;
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM user WHERE id_user ") or die ($db->error);
                            while( $datauser = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datauser['no_pegawai']; ?></td>
                                    ...
                                    <td align="center" width="100px">
                                        <a href="edit.php?id_user=<?= $datauser['id_user'] ?>" class="badge badge-info">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?id_user=<?= $datauser['id_user'] ?>" class="badge badge-danger">Hapus</a>
