...
<div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <?php
                            $no = 1;
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM data_kustomer WHERE id_kustomer ") or die ($db->error);
                            while( $datauser = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datauser['nama_lengkap']; ?></td>
                                    <td><?php echo $datauser['no_rekening']; ?></td>
                                    <td><?php echo $datauser['bank_rekening']; ?></td>
                                    <td><?php echo 'Rp. '.number_format($datauser['saldo']); ?></td>
                                    <td><?php echo $datauser['no_hp']; ?></td>
                                    <td><?php echo $datauser['alamat']; ?></td>
                                    <td align="center" width="100px">
                                    <a href="edit.php?id_kustomer=<?= $datauser['id_kustomer'] ?>" class="badge badge-info">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?id_kustomer=<?= $datauser['id_kustomer'] ?>" class="badge badge-danger">Hapus</a>
