...
$sql1=mysqli_query($koneksi,"SELECT * FROM surat_jalan INNER JOIN data_driver ON surat_jalan.id_driver = data_driver.id_driver INNER JOIN pembayaran ON surat_jalan.no_faktur = pembayaran.no_faktur where id_surat_jalan = '$id_surat_jalan'") or die (mysqli_error($koneksi));
$suratjalan=mysqli_fetch_array($sql1);
?>
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading">Edit Surat Jalan &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            ...
                            <?php
                            $user = mysqli_query($koneksi,"SELECT * FROM surat_jalan INNER JOIN data_driver ON surat_jalan.id_driver = data_driver.id_driver where id_surat_jalan = '$id_surat_jalan' ");
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            $user = mysqli_query($koneksi,"SELECT * FROM surat_jalan INNER JOIN pembayaran ON surat_jalan.no_faktur = pembayaran.no_faktur where id_surat_jalan = '$id_surat_jalan' ");
                            while($duser = mysqli_fetch_array($user)) {                           
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_jalan" value="<?php echo $suratjalan['tanggal_jalan']; ?>" class="form-control" required />
                        </div>
                    ...
                    if(@$_POST['simpan']) {
                        ...
                        mysqli_query($koneksi, "UPDATE surat_jalan SET id_driver = '$id_driver', no_faktur = '$no_faktur', tanggal_jalan = '$tanggal_jalan' WHERE id_surat_jalan = '$id_surat_jalan'") or die ($koneksi->error);
