    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar">
      ...
      <div class="app-title">
        <div>
          ...
          <strong>Assalamu'alaikum wr. wb. !!</strong> Selamat datang di halaman Admin 
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4>Costumer</h4>
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM data_kustomer ");
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4>Karyawan</h4>
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM user ");
                 echo mysqli_num_rows($pesan);
              ?> Orang</b></p>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-id-card-o fa-3x"></i>
            <div class="info">
              <h4>Driver</h4>
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM data_driver ");
                 echo mysqli_num_rows($pesan);
              ?> Orang</b></p>
            </div>
          </div>
