...
<div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM transaksi inner join data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer") or die ($koneksi->error);
                            while( $datauser = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datauser['tgl_transaksi']; ?></td>
                                    <td><?php echo $datauser['nama_lengkap']; ?></td>
                                    <td><?php echo $datauser['total_barang']; ?></td>
                                    <td><?php echo 'Rp. '.number_format($datauser['total_bayar']); ?></td>
                                    <td><?php echo $datauser['status_transaksi']; ?></td>
                                    <td align="center" width="100px">
                                    <a href="edit.php?id_transaksi=<?= $datauser['id_transaksi'] ?>" class="badge badge-info">Validasi</a>
                                    <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?id_transaksi=<?= $datauser['id_transaksi'] ?>" class="badge badge-danger">Hapus</a>
