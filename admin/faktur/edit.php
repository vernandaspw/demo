...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
      <div class="col-md-12">
            <h1 class="fa fa-table"> Data Faktur</h1>
    </div>
</div>
<?php
...
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading">Edit Data Faktur &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
<br>
                    <div class="form-group">
          <?php
          $query = "SELECT max(no_faktur) as maxKode FROM pembayaran";
          ...
          ?>
          <input type="text" name="no_faktur" class="form-control" value="<?php echo $kode ?>" readonly>
        </div>
                        </div>
                        <div class="form-group">
                            <label>Nama </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tanggal_bayar" value="<?php echo $databarang['tgl_transaksi']; ?>" class="form-control" readonly />
                        </div>
                        <div class="form-group">
                    ...
                    if(@$_POST['simpan']) {
                        ...
                        $sql1 = mysqli_query($koneksi, "INSERT INTO pembayaran (no_faktur, id_transaksi, total_bayar, status_pembayaran) VALUES ('$no_faktur', '$id_transaksi', '$total_bayar', '$status_pembayaran')") or die ($koneksi->error);
                        ...
                        $sql3 = mysqli_query($koneksi, "INSERT INTO barang_keluar (kd_barang, id_transaksi, jumlah_keluar, tanggal) VALUES ('$kd_barang', '$id_transaksi', '$jumlah_keluar', '$tanggal')");
