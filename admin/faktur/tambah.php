...
<div class="col-md-12">
          <div class="tile">
                <div class="panel-heading">Tambah Data Faktur &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <br>
                <div class="tile-body">
	            <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            $user = mysqli_query($koneksi,"SELECT * FROM data_kustomer");
