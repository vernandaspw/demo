	            ...
	            <div class="panel-body">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_pegawai" class="form-control" placeholder="Ex: 212312" required />
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_polisi" class="form-control" placeholder="Masukan No Polisi" required />
                        </div>
                        <div class="form-group">
                    ...
                    <?php
                        ...
                        $sql2 = mysqli_query($koneksi, "INSERT INTO data_driver(id_driver,  nama, no_pegawai, no_hp, alamat, no_polisi) VALUES (null, '$nama', '$no_pegawai', '$no_hp', '$alamat', '$no_polisi')") or die ($koneksi->error);
