...
<div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <?php
                            $no = 1;
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM data_driver WHERE id_driver ") or die ($db->error);
                            while( $datadriver = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datadriver['no_pegawai']; ?></td>
                                    <td><?php echo $datadriver['nama']; ?></td>
                                    <td><?php echo $datadriver['no_hp']; ?></td>
                                    <td><?php echo $datadriver['alamat']; ?></td>
                                    <td><?php echo $datadriver['no_polisi']; ?></td>
                                    <td align="center" width="100px">
                                    <a href="edit.php?id_driver=<?= $datadriver['id_driver'] ?>" class="badge badge-info">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?id_driver=<?= $datadriver['id_driver'] ?>" class="badge badge-danger">Hapus</a>
