...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
      <div class="col-md-12">
            <h1 class="fa fa-table"> Data Driver</h1>
    </div>
</div>
<?php
$id_driver = @$_GET ['id_driver'];
$sql1=mysqli_query($koneksi,"select * from data_driver where id_driver = '$id_driver'") or die (mysqli_error($koneksi));
$datadriver=mysqli_fetch_array($sql1);
?>
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading">Edit Data Driver &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
                        <div class="form-group">
                            <label>Nomor Pegawai</label>
                            <input type="text" name="no_pegawai" value="<?php echo $datadriver['no_pegawai']; ?>" class="form-control" required />
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="nama" value="<?php echo $datadriver['nama']; ?>" class="form-control" required />
                        </div>
                        <div class="form-group">
                            <label>No Hp</label>
                            <input type="text" name="no_hp" value="<?php echo $datadriver['no_hp']; ?>" class="form-control" required />
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
                            <input type="text" name="alamat" value="<?php echo $datadriver['alamat']; ?>" class="form-control" required />
                        </div>
                        <div class="form-group">
                            <label>Nomor Polisi</label>
                            <input type="text" name="no_polisi" value="<?php echo $datadriver['no_polisi']; ?>" class="form-control" required />
                        </div>
                        <div class="form-group">
                    ...
                    if(@$_POST['simpan']) {
                        ...
                        mysqli_query($koneksi, "UPDATE data_driver SET no_pegawai = '$no_pegawai', nama = '$nama', no_hp = '$no_hp', alamat = '$alamat', no_polisi = '$no_polisi' WHERE id_driver = '$id_driver'") or die ($koneksi->error);
