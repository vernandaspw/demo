	            ...
	            <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_rekening" class="form-control" placeholder="Ex: 212312" required />
                        </div>
                        <div class="form-group">
                            <label>Bank Rekening</label>
                            <input type="text" name="bank_rekening" class="form-control" placeholder="Ex: Bank Mandiri" required />
                        </div>
                        <div class="form-group">
                            <label>Saldo</label>
                            <input type="text" name="saldo" class="form-control" placeholder="Masukan Jumlah Saldo" required />
                        </div>
                        <div class="form-group">
                    ...
                    <?php
                        ...
                        $sql1 = mysqli_query($koneksi, "INSERT INTO user(id_user, nama, username, email, password, level) VALUES (null, '$nama', '$username', '$email', '$password', 'Customer')") or die ($koneksi->error);
                        $sql2 = mysqli_query($koneksi, "INSERT INTO data_kustomer(id_kustomer,  nama, no_rekening, bank_rekening, saldo, no_hp, alamat) VALUES (null, '$nama', '$no_rekening', '$bank_rekening', '$saldo', '$no_hp', '$alamat')") or die ($koneksi->error);
