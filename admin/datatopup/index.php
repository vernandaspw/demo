...
<div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <?php
                            $no = 1;
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM topup_saldo INNER JOIN data_kustomer ON topup_saldo.id_kustomer = data_kustomer.id_kustomer ") or die ($koneksi->error);
                            while( $datatopup = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datatopup['nama_lengkap']; ?></td>
                                    <td><?php echo 'Rp. '.number_format($datatopup['jumlah_topup']); ?></td>
                                    <td><?php echo $datatopup['tanggal_topup']; ?></td>
                                    <td><?php echo $datatopup['status_topup']; ?></td>
                                    <td style="text-align: center;"><img src="../bukti/<?php echo $datatopup['bukti_pembayaran']; ?>" style="width: 120px;"></td>
                                    <td style="text-align: center;">
                                    <a href="edit.php?id_kustomer=<?= $datatopup['id_kustomer'] ?>" class="badge badge-info">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?id_topup=<?= $datatopup['id_topup'] ?>" class="badge badge-danger">Hapus</a>
