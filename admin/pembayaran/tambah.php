...
<div class="col-md-12">
          <div class="tile">
                <div class="panel-heading">Tambah Data Pembayaran &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <br>
                <div class="tile-body">
	            <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            $user = mysqli_query($koneksi,"SELECT * FROM transaksi inner join data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer INNER JOIN data_barang ON transaksi.kd_barang = data_barang.kd_barang INNER JOIN user on data_kustomer.nama = user.nama  ");
                            while($duser = mysqli_fetch_array($user)) {                           
                              echo "<option value='$duser[id_transaksi]'> $duser[nama]</option>";
                             }                        
                            ?>  
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="total_bayar" class="form-control" placeholder="Masukan Total Bayar" required />
                        </div>
                        <div class="form-group">
                            <label>Tanggal Bayar</label>
                            <input type="date" name="tanggal_bayar" class="form-control" placeholder="" required />
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                    ...
                    <?php
                        ...
                        $sql1 = mysqli_query($koneksi, "INSERT INTO pembayaran(no_faktur, id_transaksi, total_bayar, tanggal_bayar, status_pembayaran) VALUES ('$no_faktur', '$id_transaksi', '$total_bayar', '$tanggal_bayar', '$status_pembayaran')") or die ($koneksi->error);
