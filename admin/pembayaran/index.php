...
<div class="col-md-12">
              <div class="tile">
              <div class="panel-heading"><a href="cetak.php" class="btn btn-success btn-sm">Cetak</a></div>
                <br>
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM pembayaran inner join transaksi on pembayaran.id_transaksi = transaksi.id_transaksi INNER JOIN data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer ") or die ($koneksi->error);
