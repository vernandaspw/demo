    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-6">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-print fa-3x"></i>
            <div class="info">
              <h4><a href="cetakbarang.php">Cetak Data Barang</h4>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-print fa-3x"></i>
            <div class="info">
            <h4><a href="cetakbarangkeluar.php">Cetak Barang Keluar</h4>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-print fa-3x"></i>
            <div class="info">
            <h4><a href="cetakbarangmasuk.php">Cetak Barang Masuk</h4>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-print fa-3x"></i>
            <div class="info">
            <h4><a href="cetaktransaksi.php">Cetak Transaksi</h4>
            </div>
          </div>
        </div>
