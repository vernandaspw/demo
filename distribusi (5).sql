...
(11, 'ACE200', 1, '2022-01-23'),
(12, 'ADMIL1', 3, '2022-01-23');
...
('ACE200', 'ACEMAIN 100 ML X 8012', 'INSC2', 'BTL2', 28, 180002),
('ADMIL1', 'ADMIL 160 SL 1 LTR X 20', 'HERB', 'Bungkus', 74, 20000),
...
(8, 'NO-002-FKT', 6, 0, '0000-00-00', 'Sudah Di Bayar'),
(9, 'NO-003-FKT', 10, 0, '0000-00-00', 'Transfer');
...
(7, 2, 'NO-002-FKT', '2022-01-22', '', ''),
(8, 1, 'NO-003-FKT', '2022-01-23', '', '');
...
(8, 1, 1, '180002', '2022-01-23', ''),
(9, 1, 3, '220002', '2022-01-23', ''),
(10, 1, 11, '380002', '2022-01-23', 'Sedang Di Kemas');
...
--
ALTER TABLE `barang_keluar`
  MODIFY `id_barang_keluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `surat_jalan`
  MODIFY `id_surat_jalan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
