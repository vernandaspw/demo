...
<div class="col-md-12">
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM pembayaran inner join transaksi on pembayaran.id_transaksi = transaksi.id_transaksi INNER JOIN data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer where username = '$username'") or die ($koneksi->error);
                            while( $datauser = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datauser['no_faktur']; ?></td>
                                    <td><?php echo $datauser['nama_lengkap']; ?></td>
                                    <td><?php echo 'Rp. '.number_format($datauser['total_bayar']); ?></td>
                                    <td><?php echo $datauser['status_pembayaran']; ?></td>
                                    <td align="center" width="100px">

                                    <a href="bayar.php?id_pembayaran=<?= $datauser['id_pembayaran'] ?>" class="badge badge-info">Bayar</a>
                                    <a href="cetak.php?id_pembayaran=<?= $datauser['id_pembayaran'] ?>" class="badge badge-primary">Cetak Faktur</a>
