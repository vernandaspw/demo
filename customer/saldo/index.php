...
$sql1=mysqli_query($koneksi,"SELECT SUM(data_kustomer.saldo) AS jumlah FROM data_kustomer WHERE id_kustomer = '$id_kustomer'") or die (mysqli_error($koneksi));
...
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading"><a href="tambah.php" class="btn btn-primary btn-sm">Top UP Saldo</a></div>
                <br>
              ...
              <div class="table-responsive">
                ...
                <thead>
                            ...
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM topup_saldo INNER JOIN data_kustomer WHERE username = '$username'") or die ($koneksi->error);
                            while( $datauser = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datauser['nama_lengkap']; ?></td>
                                    <td><?php echo 'Rp. '.number_format($datauser['jumlah_topup']); ?></td>
                                    <td><?php echo $datauser['tanggal_topup']; ?></td>
                                    <td><?php echo $datauser['status_topup']; ?></td>
                                    <td style="text-align: center;"><img src="../../admin/bukti/<?php echo $datauser['bukti_pembayaran']; ?>" style="width: 120px;"></td>
