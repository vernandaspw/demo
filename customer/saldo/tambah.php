...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
      <div class="col-md-12">
            <h1 class="fa fa-table"> TOP UP Saldo</h1>
    </div>
</div>
<div class="col-md-12">
          <div class="tile">
                <div class="panel-heading">Tambah Saldo &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <br>
                <div class="tile-body">
              ...
              <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumlah_topup" class="form-control" placeholder="Masukan Jumlah" required />
                        </div>
                        <div class="form-group">
                            <label>Tanggal Top Up</label>
                            <input type="date" name="tanggal_topup" class="form-control" placeholder="" required />
                        </div>
                        <div class="form-group">
			                  <label>Foto </label>
