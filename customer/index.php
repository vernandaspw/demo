    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar">
      ...
      <div class="app-title">
        <div>
          ...
          <strong>Assalamu'alaikum wr. wb. !!</strong> Selamat datang di Halaman Customer 
        </div>
      </div>
      <div class="row">
      <?php 
                 $id_kustomer = $_SESSION['id_kustomer'];  
                 $saldo = mysqli_query($koneksi,"SELECT * FROM data_kustomer WHERE id_kustomer = '$id_kustomer'") or die (mysqli_error($koneksi));
                 $datasaldo = mysqli_fetch_array($saldo);
                 $jumlahsaldo = $datasaldo['saldo'];
      ?>
      ...
      <div class="col-md-8 col-lg-6">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-money fa-3x"></i>
            <div class="info">
              <h4>Saldo Anda</h4>
              <p><b><?php echo 'Rp. '.number_format($jumlahsaldo); ?></b></b></p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8 col-lg-6">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
            <div class="info">
              <h4>Pesanan Barang Anda</h4>
              <p><b><?php 
                 $username = $_SESSION['username'];  
                 $pesan = mysqli_query($koneksi,"SELECT * FROM transaksi inner join data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer WHERE username = '$username' ") or die (mysqli_error($koneksi));
