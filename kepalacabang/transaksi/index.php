...
<html lang="en">
  <head>
    ...
    <title>Halaman Kepala Cabang</title>
    <meta charset="utf-8">
...
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading"><a href="cetak.php" class="btn btn-primary btn-sm">Cetak Data</a></div>
                <br>
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            $sql1 = mysqli_query($koneksi, "SELECT * FROM transaksi inner join data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer INNER JOIN data_barang ON transaksi.kd_barang = data_barang.kd_barang") or die ($koneksi->error);
                            while( $datauser = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $datauser['nama_barang']; ?></td>
                                    <td><?php echo $datauser['nama_lengkap']; ?></td>
                                    <td><?php echo $datauser['jumlah_stok']; ?></td>
                                    <td><?php echo $datauser['tanggal_transaksi']; ?></td>
