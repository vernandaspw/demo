    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar">
      ...
      <div class="app-title">
        <div>
          ...
          <strong>Assalamu'alaikum wr. wb. !!</strong> Selamat datang di halaman User Gudang
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-briefcase fa-3x"></i>
            <div class="info">
              <h4>Data Barang</h4>
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM data_barang ");
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM transaksi ");
                 echo mysqli_num_rows($pesan);
              ?> Transaksi</b></p>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-briefcase fa-3x"></i>
            <div class="info">
              <h4>Barang Masuk</h4>
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM barang_masuk ");
                 echo mysqli_num_rows($pesan);
              ?> Barang</b></p>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-briefcase fa-3x"></i>
            <div class="info">
              <h4>Barang Keluar</h4>
              <p><b><?php 
                 $pesan = mysqli_query($koneksi,"SELECT * FROM barang_keluar ");
                 echo mysqli_num_rows($pesan);
              ?> Barang</b></p>
            </div>
          </div>
