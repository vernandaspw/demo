                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            while( $databarang = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo 'Rp. '.number_format($databarang['harga_jual']); ?></td>
                                    <td align="center" width="100px">
                                    <a href="edit.php?kd_barang=<?= $databarang['kd_barang'] ?>" class="badge badge-info">Edit</a>
                                        <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?kd_barang=<?= $databarang['kd_barang'] ?>" class="badge badge-danger">Hapus</a>
