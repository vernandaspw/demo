                ...
                <div class="panel-body">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="kd_barang" value="<?php echo $databarang['kd_barang']; ?>" class="form-control" required readonly />
                        </div>
                        <div class="form-group">
                    ...
                    if(@$_POST['simpan']) {
                     ...
                     $harga_jual = mysqli_real_escape_string($koneksi, $_POST['harga_jual']);
                        ...
                        mysqli_query($koneksi, "UPDATE data_barang SET kd_barang = '$kd_barang', nama_barang = '$nama_barang', jenis = '$jenis', satuan = '$satuan', harga_jual = '$harga_jual' WHERE kd_barang = '$kd_barang'") or die ($koneksi->error);
