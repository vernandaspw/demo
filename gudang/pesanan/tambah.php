	            ...
	            <div class="panel-body">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="kd_barang" class="form-control" placeholder="Masukan Kode Barang" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Satuan</label>
                            <input type="text" name="satuan" class="form-control" placeholder="Masukan Satuan Barang" required />
                        </div>
                        <div class="form-group">
                            <label>Harga Jual</label>
                            <input type="text" name="harga_jual" class="form-control" placeholder="Ex: 50000" required />
                        </div>
                        <div class="form-group">
                    ...
                    <?php
                        ...
                        $sql1 = mysqli_query($koneksi, "INSERT INTO data_barang(kd_barang, nama, jenis, satuan, harga_jual, keterangan) VALUES ('$kd_barang' , '$nama', '$jenis', '$satuan', '$harga_jual', '$keterangan')") or die ($koneksi->error);
