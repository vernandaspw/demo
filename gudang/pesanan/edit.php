...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
      <div class="col-md-12">
            <h1 class="fa fa-table"> Data Pesanan Barang</h1>
    </div>
</div>
<?php
$pembelian = @$_GET ['pembelian'];
$no = 1;
$sql1 = mysqli_query($koneksi, "SELECT * FROM transaksi inner join data_kustomer on transaksi.id_kustomer = data_kustomer.id_kustomer INNER JOIN detail_transaksi on transaksi.id_transaksi = detail_transaksi.id_transaksi Where kd_barang = '$pembelian' ") or die ($koneksi->error);
$databarang=mysqli_fetch_array($sql1);
?>
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading">Edit Data Pesanan Barang &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    ...
                    if(@$_POST['simpan']) {
                        ...
                        $jumlah    = $stok - $jumlah_keluar;

                        $sql1 = mysqli_query($koneksi, "INSERT INTO barang_keluar (kd_barang, jumlah_keluar, tanggal) VALUES ('$kd_barang' , '$jumlah_keluar', '$tanggal')") or die ($koneksi->error);
