	            ...
	            <div class="panel-body">
                    ...
                    <div class="form-group">
                            ...
                            while($duser = mysqli_fetch_array($user)) {                           
                              echo "<option value='$duser[kd_barang]'> $duser[kd_barang]</option>";
                             }                        
                            ?>  
                            </select>
                        </div>
                    ...
                    <?php
                        ...
                        $sql1 = mysqli_query($koneksi, "INSERT INTO barang_masuk(id_barang_masuk, kd_barang, jumlah_masuk, tanggal, keterangan) VALUES (null, '$kd_barang' , '$jumlah_masuk', '$tanggal', '$keterangan')") or die ($koneksi->error);
