...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
      <div class="col-md-12">
            <h1 class="fa fa-table"> Data Barang Keluar</h1>
    </div>
</div>
<?php
$kd_barang = @$_GET ['kd_barang'];
$sql1=mysqli_query($koneksi,"SELECT * from barang_keluar where id_barang_keluar = '$kd_barang'") or die (mysqli_error($koneksi));
$databarang=mysqli_fetch_array($sql1);
?>
<div class="col-md-12">
              <div class="tile">
                <div class="panel-heading">Edit Data Barang Keluar &nbsp; <a href="index.php" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumlah_masuk" value="<?php echo $databarang['jumlah_keluar']; ?>" class="form-control" readonly />
                        </div>
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input type="date" name="tanggal" value="<?php echo $databarang['tanggal']; ?>" class="form-control" readonly />
                        </div>
