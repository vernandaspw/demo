                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            while( $databarang = mysqli_fetch_array($sql1)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $databarang['jumlah_masuk']; ?></td>
                                    <td><?php echo $databarang['tanggal']; ?></td>
                               
                                    <td align="center" width="100px">
                                    <a href="edit.php?id_barang_masuk=<?= $databarang['id_barang_masuk'] ?>" class="badge badge-info">Edit</a>
                                    <a onclick="return confirm('Yakin akan menghapus data?');" href="hapus.php?id_barang_masuk=<?= $databarang['id_barang_masuk'] ?>" class="badge badge-danger">Hapus</a>
                                  </td>
                                </tr>
                            <?php
                            } ?>
